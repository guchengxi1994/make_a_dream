...
# 修改路径
image_paths = glob.glob(r"D:\github_repo\make_a_dream\assets\images\tiled\maps\road_48/*.png")
...
merged_image = merged_image.resize((int(merged_image.size[0]),int(merged_image.size[1])))
