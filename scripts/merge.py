...
image_paths = glob.glob(
    r"D:\github_repo\make_a_dream\assets\images\tiled\maps\seprated_items/*.png"
)
...
merged_image = merged_image.resize(
    (int(merged_image.size[0]), int(merged_image.size[1]))
)

# 保存合并后的图像
merged_image.save("seprate_item.png", format="PNG")
